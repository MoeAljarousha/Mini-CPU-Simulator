...
import { CAR_MAKES, CAR_MODELS, PRICE_RANGES, CAR_TRIMS } from '../types/car';
...
const CarInquiry = ({ onFiltersChange }: CarInquiryProps) => {
  const { getAvailableMakes, getAvailableModels } = useCarData();
  ...
  const availableModels = formData.make ? getAvailableModels(formData.make) : [];
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    console.log('Car search submitted:', formData);
